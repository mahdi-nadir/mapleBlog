    <div class="mainChatWindow text-md md:text-lg w-3/4 md:w-1/4 border-2 border-black bg-slate-100 rounded flex-row justify-end items-end mr-2 mb-2" style="display: none;">
        ...
        <div class="chatDiv chatArea overflow-y-auto overflow-x-hidden">
            <div class="messageBot text-start flex flex-row justify-around items-end gap-2">
                ...
                <div>
                    <h3 class="hey rounded-lg p-1 my-1 p-2 text-sm md:text-md bg-teal-100 w-5/6 text-justify" style="display: none;">Hey There! I'm Medy, your personal assistant!</h3>
                    <h3 class="masculinePronoun rounded-lg p-1 my-1 p-2 text-sm md:text-md bg-teal-100 w-5/6 text-justify" style="display: none;">It's important to understand that using masculine pronouns is not indicative of sexism, but rather a reflection of simplicity.</h3>
                    <h3 class="whatLang rounded-lg p-1 my-1 p-2 text-sm md:text-md bg-teal-100 w-5/6 text-justify" style="display: none;">What language do you prefer?
