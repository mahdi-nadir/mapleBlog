<x-app-layout>
    <section id="eligibility_calculator">
        <div>
            ...
            <div class='eligibility-div bg-slate-200 dark:bg-slate-800 w-[90%] md:w-2/3 mt-10 mx-auto text-center p-6 border-2 border-black rounded-lg'>
                <div class="flex flex-col justify-center items-center gap-4">
                    <h1 class='maritalTitle text-xl md:text-2xl font-bold'>{{ __('maritalStatus') }}</h1>
                    <div class="flex flex-row justify-center items-center gap-2">
                        <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 custom-select w-[180px] md:w-[250px] overflow-hidden whitespace-nowrap overflow-ellipsis marital-status" name="marital-status" id="marital-status">
                ...
                <div class="ageDiv flex flex-col justify-center items-center gap-4 mt-10" style="display: none;">
                    ...
                    <div class="flex flex-row justify-center items-center gap-2 mt-3">
                        <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 w-[180px] md:w-[250px]" name="age" id="age">
                            <option value="">{{ __('select') }}</option>
                        ...
                        <i class="fa-solid fa-question rounded p-1 border-red-900 hover:bg-red-900 hover:text-white text-bold cursor-pointer text-red-800 dark:text-gray-100 dark:hover:text-gray-50 questionAge"></i>
                    </div>
                ...
                <div style="display: none;" class="educationDiv flex flex-col justify-center items-center gap-4 mt-10">
                    ...
                    <div class="flex flex-row justify-center items-center gap-2 mt-3">
                        <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 w-[180px] md:w-[250px]" name="education" id="education">
                            <option value="">{{ __('select') }}</option>
                        ...
                        <i class="fa-solid fa-question rounded p-1 border-red-900 hover:bg-red-900 hover:text-white text-bold cursor-pointer text-red-800 dark:text-gray-100 dark:hover:text-gray-50 questionEducation"></i>
                    </div>
                ...
                <div style="display: none;" class="first-language-div">
                    ...
                    <div class="flex flex-col justify-center items-center gap-2">
                        <label class="font-bold italic text-slate-600 dark:text-slate-100" htmlFor="first-language-availability">{{ __('testValid') }}</label>
                        <div class="flex flex-row justify-center items-center gap-2">
                            <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 w-[180px] md:w-[250px]" name="first-language-availability" id="first-language-availability">
                                <option value="">{{ __('select') }}</option>
                                <option value="no">{{ __('no') }}</option>
                                <option value="yes">{{ __('yes') }}</option>
                            </select>
                            <i class="fa-solid fa-question rounded p-1 border-red-900 hover:bg-red-900 hover:text-white text-bold cursor-pointer text-red-800 dark:text-gray-100 dark:hover:text-gray-50 questionFirstLangAvailability"></i>
                        </div>
                    ...
                    <div style="display: none;" class="first-language-typeDiv flex justify-center items-center gap-4 mt-8">
                            <label class="font-bold italic text-slate-600 dark:text-slate-100" htmlFor="first-language-type">{{ __('whichLang1') }}</label><br>
                            <div class="flex flex-row justify-center items-center gap-2"></div>
                            <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 mt-3 w-[180px] md:w-[250px]" name="first-language-type" id="first-language-type">
                                <option value="">{{ __('select') }}</option>
                            ...
                            <i class="fa-solid fa-question rounded p-1 border-red-900 hover:bg-red-900 hover:text-white text-bold cursor-pointer text-red-800 dark:text-gray-100 dark:hover:text-gray-50 questionFirstLangScores"></i>
                        </div>
                    ...
                    <div style="display: none;" class="first-language-scoresDiv flex flex-col justify-center items-center gap-2 mt-8">
                        <label class="font-bold italic text-slate-600 dark:text-slate-100">{{ __('setUrScores') }}</label>
                        <div class="flex flex-col justify-center items-center gap-2 mt-2">
                            ...
                            <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 mb-4 w-1/3 md:w-1/4" name="first-language-reading" id="first-language-reading">
                                <option value="">{{ __('select') }}</option>
                        ...
                        <div class="flex flex-col justify-center items-center gap-2 mt-2">
                            ...
                            <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 mb-4 w-1/3 md:w-1/4" name="first-language-writing" id="first-language-writing">
                                <option value="">{{ __('select') }}</option>
                        ...
                        <div class="flex flex-col justify-center items-center gap-2 mt-2">
                            ...
                            <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 mb-4 w-1/3 md:w-1/4" name="first-language-listening" id="first-language-listening">
                                <option value="">{{ __('select') }}</option>
                        ...
                        <div class="flex flex-col justify-center items-center gap-2 mt-2">
                            ...
                            <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 mb-4 w-1/3 md:w-1/4" name="first-language-speaking" id="first-language-speaking">
                                <option value="">{{ __('select') }}</option>
                ...
                <div style="display: none;" class="second-language-div">
                    ...
                    <div class="flex flex-col justify-center items-center gap-4">
                        <label class="font-bold italic text-slate-600 dark:text-slate-100" htmlFor="second-language-availability">{{ __('secondLangValid') }}</label>
                        <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 w-[180px] md:w-[250px]" name="second-language-availability" id="second-language-availability">
                            <option value="">{{ __('select') }}</option>
                            <option value="no">{{ __('no') }}</option>
                            <option value="yes">{{ __('yes') }}</option>
                        </select>
                    ...
                    <div style="display: none;" class="flex flex-col justify-center items-center gap-4 mt-10 second-language-typeDiv">
                        <label class="font-bold italic text-slate-600 dark:text-slate-100" htmlFor="second-language-type">{{ __('whichLang2') }}</label><br>
                        <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 mt-3 w-[180px] md:w-[250px]" name="second-language-type" id="second-language-type">
                            <option value="">{{ __('select') }}</option>
                            <option value="ielts">IELTS</option>
                            <option value="celpip">CELPIP</option>
                            <option value="tef-canada">TEF Canada</option>
                    ...
                    <div style="display: none;" class="second-language-scoresDiv flex flex-col justify-center items-center gap-2 mt-10">
                        <label class="font-bold italic text-slate-600 dark:text-slate-100">{{ __('gotClb2') }}</label>
                        <div class="flex flex-row justify-center items-center gap-2 mt-3">
                            <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 w-[180px] md:w-[250px]" name="second-language-scores" id="second-language-scores">
                                <option value="">{{ __('select') }}</option>
                                <option value="no">{{ __('no') }}</option>
                                <option value="yes">{{ __('yes') }}</option>
                            </select>
                            <i class="fa-solid fa-question rounded p-1 border-red-900 hover:bg-red-900 hover:text-white text-bold cursor-pointer text-red-800 dark:text-gray-100 dark:hover:text-gray-50 questionSecondLangScores"></i>
                        </div>
                ...
                <div style="display: none;" class="work-experience-div flex flex-col justify-center items-center gap-4 mt-10">
                    ...
                    <label class="font-bold italic text-slate-600 dark:text-slate-100" htmlFor="work-experience">{{ __('workExpHowMany') }}</label>
                    <div class="flex flex-row justify-center items-center gap-2 mt-3">
                        <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 w-[180px] md:w-[250px]" name="work-experience" id="work-experience">
                            <option value="">{{ __('select') }}</option>
                        ...
                        <i class="fa-solid fa-question rounded p-1 border-red-900 hover:bg-red-900 hover:text-white text-bold cursor-pointer text-red-800 dark:text-gray-100 dark:hover:text-gray-50 questionWorkExp"></i>
                    </div>
                ...
                <div style="display: none;" class="reserved-job-position-in-canada-div flex flex-col justify-center items-center gap-4 mt-10">
                    ...
                    <label class="font-bold italic text-slate-600 dark:text-slate-100" htmlFor="reserved-job-position-in-canada">
                        {{ __('reservedOccQuestion') }}
                    </label>
                    <div class="flex flex-row justify-center items-center gap-2 mt-3">
                        <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 w-[180px] md:w-[250px]" name="reserved-job-position-in-canada" id="reserved-job-position-in-canada">
                            <option value="">{{ __('select') }}</option>
                            <option value="no">{{ __('no') }}</option>
                            <option value="yes">{{ __('yes') }}</option>
                        </select>
                        <i class="fa-solid fa-question rounded p-1 border-red-900 hover:bg-red-900 hover:text-white text-bold cursor-pointer text-red-800 dark:text-gray-100 dark:hover:text-gray-50 questionReservedJob"></i>
                    </div>
                ...
                <div style="display: none;" class="study-canada-div flex flex-col justify-center items-center gap-4">
                    ...
                    <label class="font-bold italic text-slate-600 dark:text-slate-100" htmlFor="study-canada">{{ __('studiesCanadaQuestion') }}</label>
                    <div class="flex flex-row justify-center items-center gap-2 mt-3">
                        <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 w-[180px] md:w-[250px]" name="study-canada" id="study-canada">
                            <option value="">{{ __('select') }}</option>
                            <option value="no">{{ __('no') }}</option>
                            <option value="yes">{{ __('yes') }}</option>
                        </select>
                        <i class="fa-solid fa-question rounded p-1 border-red-900 hover:bg-red-900 hover:text-white text-bold cursor-pointer text-red-800 dark:text-gray-100 dark:hover:text-gray-50 questionStudyCanada"></i>
                    </div>
                ...
                <div style="display: none;" class="work-experience-canada-div flex flex-col justify-center items-center gap-4">
                    ...
                    <label class="font-bold italic text-slate-600 dark:text-slate-100" htmlFor="work-experience-canada">{{ __('workExpCanadaQuestion') }}</label><br>
                    <div class="flex flex-row justify-center items-center gap-2 mt-3">
                        <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 w-[180px] md:w-[250px]" name="work-experience-canada" id="work-experience-canada">
                            <option value="">{{ __('select') }}</option>
                            <option value="no">{{ __('no') }}</option>
                            <option value="yes">{{ __('yes') }}</option>
                        </select>
                        <i class="fa-solid fa-question rounded p-1 border-red-900 hover:bg-red-900 hover:text-white text-bold cursor-pointer text-red-800 dark:text-gray-100 dark:hover:text-gray-50 questionWorkExpCanada"></i>
                    </div>
                ...
                <div style="display: none;" class="job-offer-div flex flex-col justify-center items-center gap-4">
                    ...
                    <label class="font-bold italic text-slate-600 dark:text-slate-100" htmlFor="job-offer">{{ __('arrangedEmploymentQuestion') }}</label><br>
                    <div class="flex flex-row justify-center items-center gap-2 mt-3">
                        <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 w-[180px] md:w-[250px]" name="job-offer" id="job-offer">
                            <option value="">{{ __('select') }}</option>
                            <option value="no">{{ __('no') }}</option>
                            <option value="yes">{{ __('yes') }}</option>
                        </select>
                        <i class="fa-solid fa-question rounded p-1 border-red-900 hover:bg-red-900 hover:text-white text-bold cursor-pointer text-red-800 dark:text-gray-100 dark:hover:text-gray-50 questionJobOffer"></i>
                    </div>
                ...
                <div style="display: none;" class="relatives-div flex flex-col justify-center items-center gap-4">
                    ...
                    <label class="font-bold italic text-slate-600 dark:text-slate-100" htmlFor="relatives">{{ __('relativesQuestion1') }} <span id="marriedOrNot"></span> {{ __('relativesQuestion2') }}</label>
                    <div class="flex flex-row justify-center items-center gap-2 mt-3">
                        <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 w-[180px] md:w-[250px]" name="relatives" id="relatives">
                            <option value="">{{ __('select') }}</option>
                            <option value="no">{{ __('no') }}</option>
                            <option value="yes">{{ __('yes') }}</option>
                        </select>
                        <i class="fa-solid fa-question rounded p-1 border-red-900 hover:bg-red-900 hover:text-white text-bold cursor-pointer text-red-800 dark:text-gray-100 dark:hover:text-gray-50 questionRelatives"></i>
                    </div>
                ...
                <div style="display: none;" class="spouse-language-div flex flex-col justify-center items-center gap-4">
                    ...
                    <label class="font-bold italic text-slate-600 dark:text-slate-100" htmlFor="spouse-language-availability">{{ __('spouseLangSkillsQuestion') }}</label>
                    <div class="flex flex-row justify-center items-center gap-2 mt-3">
                        <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 w-[180px] md:w-[250px]" name="spouse-language-availability" id="spouse-language-availability">
                            <option value="">{{ __('select') }}</option>
                            <option value="no">{{ __('no') }}</option>
                            <option value="yes">{{ __('yes') }}</option>
                        </select>
                        <i class="fa-solid fa-question rounded p-1 border-red-900 hover:bg-red-900 hover:text-white text-bold cursor-pointer text-red-800 dark:text-gray-100 dark:hover:text-gray-50 questionSpouseLangAvailability"></i>
                    </div>
                ...
                <div style="display: none;" class="spouse-education-div flex flex-col justify-center items-center gap-4">
                    ...
                    <label class="font-bold italic text-slate-600 dark:text-slate-100" htmlFor="spouse-education">{{ __('spouseEduQuestion') }}</label>
                    <div class="flex flex-row justify-center items-center gap-2 mt-3">
                        <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 w-[180px] md:w-[250px]" name="spouse-education" id="spouse-education">
                            <option value="">{{ __('select') }}</option>
                            <option value="no">{{ __('no') }}</option>
                            <option value="yes">{{ __('yes') }}</option>
                        </select>
                        <i class="fa-solid fa-question rounded p-1 border-red-900 hover:bg-red-900 hover:text-white text-bold cursor-pointer text-red-800 dark:text-gray-100 dark:hover:text-gray-50 questionSpouseEducation"></i>
                    </div>
                ...
                <div style="display: none;" class="spouse-work-experience-div flex flex-col justify-center items-center gap-4">
                    ...
                    <label class="font-bold italic text-slate-600 dark:text-slate-100" htmlFor="spouse-work-experience">{{ __('spouseWorkExpQuestion') }}</label>
                    <div class="flex flex-row justify-center items-center gap-2 mt-3">
                        <select class="rounded bg-slate-100 dark:text-black border-red-800 dark:border-gray-400 border-4 w-[180px] md:w-[250px]" name="spouse-work-experience" id="spouse-work-experience">
                            <option value="">{{ __('select') }}</option>
                            <option value="no">{{ __('no') }}</option>
                            <option value="yes">{{ __('yes') }}</option>
                        </select>
                        <i class="fa-solid fa-question rounded p-1 border-red-900 hover:bg-red-900 hover:text-white text-bold cursor-pointer text-red-800 dark:text-gray-100 dark:hover:text-gray-50 questionSpouseWorkExp"></i>
                    </div>
