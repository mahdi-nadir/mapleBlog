<x-app-layout>
    <section id="suggestedpnp">
        <div class="flex flex-col justify-center items-center gap-3">
            ...
            <p><b>{{ __('pnpSuggestMsg3') }} <a href="https://www.statcan.gc.ca/en/statistical-programs/document/noc2016v1_3-noc2021v1_0" class="text-blue-700 dark:text-blue-300 hover:text-blue-500 hover:dark:text-blue-500 underline" target="_blank" rel="noreferrer">{{ __('pnpSuggestMsg4') }}</a></b></p>
        </div>
        ...
        <div class="flex flex-col justify-center items-center gap-6 w-full mx-auto p-6">
            <div class="flex flex-col md:flex-row justify-center items-center gap-8 w-full">
                <div class="flex flex-col justify-center items-center gap-2 w-1/2 md:w-1/4">
                    <label for="nocCode" class="font-bold text-xl md:text-2xl">{{ __('nocCode') }}</label>
                    <input class="rounded text-center bg-slate-100 border-red-800 border-4 text-lg w-full dark:text-black dark:border-gray-400" type="number" name="nocCode" id="nocCode" min="1000" max="99999">
                </div>
                <div class="flex flex-col justify-center items-center gap-2 w-1/2 md:w-1/4">
                    <label for="crsScore" class="font-bold text-xl md:text-2xl">{{ __('crsScore') }}</label>
                    <input class="rounded text-center bg-slate-100 border-red-800 border-4 text-lg w-full dark:text-black dark:border-gray-400" type="number" name="crsScore" id="crsScore" min="1" max="1200">
                </div>
            </div>
